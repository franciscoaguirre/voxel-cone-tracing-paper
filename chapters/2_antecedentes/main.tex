...
La misma no presenta una solución analítica cerrada para la mayoría de los casos, por lo que se precisan soluciones numéricas para su resolución.
...
La difusa refleja la luz en todas las direcciones de igual manera.
...
Los conos, en cambio, tienen un ángulo de apertura, lo que agrega un grosor no despreciable.
