...
Se utiliza una operación atómica de la GPU, por lo que dos hilos efectuando la operación al mismo tiempo sobre el mismo bit no interfieren entre ellos.
...
\begin{figure}[h!]
    ...
    \caption{Vóxeles en los que se ha subdividido la geometría y el brick donde van a terminar.}
...
De esta figura también se desprende la necesidad del \textit{border transfer} \ref{sec:border_transfer}, ya que los espacios blancos de los vóxeles del brick deben ser rellenados con información de nodos vecinos.
...
Sus \textit{bricks} tienen vóxeles con valor de opacidad $0$.
Existen solo para asegurar una correcta interpolación en los extremos de la geometría.
