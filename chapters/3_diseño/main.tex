...
De esta manera, aún cuando un vóxel puede estar en varios bricks, en $8$ como máximo para los vóxeles en las esquinas de los bricks, su valor va a ser siempre el mismo en cada uno de ellos. % Creo que tiene razon Eduardo, pero no hay ganas de cambiarlo
...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=.75\textwidth]{sombra-interpolada.png}
        \caption{Con nodos frontera}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=.75\textwidth]{sombra-no-interpolada.png}
